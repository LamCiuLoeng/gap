...
%>
<%def name="extTitle()">r-pac - Current inventory levels Report</%def>
...
<div class="nav-tree">Current inventory levels&nbsp;&nbsp;&gt;&nbsp;&nbsp;Report</div>


<div>
	${widget(values,action=("/cireport/export"))|n}
</div>
