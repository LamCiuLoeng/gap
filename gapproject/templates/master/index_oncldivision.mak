    ...
    //<![CDATA[
		...
		function toDel(id){
		    if(window.confirm("Are you sure to delete this record?")){
		        window.location.href='/${funcURL}/delete?id=' + id;
		        return true;
		    }else{
		        return false;
		    }
...
%if result:
	...
	<table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:800px">
		<thead>
			...
			<tr>
				<th style="width:400px">Department Name</th>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					%if in_group("Admin"):
					<a href="/${funcURL}/update?id=${u.id}">Edit</a>&nbsp;&nbsp;
					<a href="#" onclick="toDel(${u.id})">Delete</a>
					%else:
					&nbsp;
					%endif
					&nbsp;
