...
<table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:900px">
    <thead>
        ...
        <tr>
            ...
            <th width="150">Gusset</th>
            <th width="150">Lip</th>
            <th width="450">Item Category</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td><a href="/${funcURL}/update?id=${u.id}" class="${'required link-text' if u.active==1 else 'link-text'}">${u.item_number}</a>&nbsp;</td>
            <td>${u.description}&nbsp;</td>
            <td>${u.width}&nbsp;</td>
            <td>${u.length}&nbsp;</td>
            <td>${u.gusset}&nbsp;</td>
