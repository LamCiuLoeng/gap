...
<div style="margin-bottom: 540px;"></div>
</div>
% endfor
...
<!-- 			<div class="fibers">
				<div class="term">SHELL/EXTÉRIEUR/面料/表地/هيكل</div>
				<ul class="square">
					<li>■ 100% COTTON</li>
					<li>■ <strong>CA</strong>: 100% COTON</li>
					<li>■ <strong>JP</strong>: 100% 綿</li>
					<li>■ <strong>CH</strong>: 100% 棉</li>
					<li>■ <strong>UAE</strong>: 100% نطقلا</li>
				</ul>
			</div> -->
