...
<div id="function-menu">
  ...
  <tbody><tr>
    ...
    <td width="64" valign="top" align="left"><a href="/access/group_add"><img src="/images/images/menu_new_g.jpg"/></a></td>
	...
	<table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:800px">
      ...
      %endif
		...
		<tbody>
			...
			<tr>
				<td>${g}&nbsp;</td>
				<td>${g.created.strftime("%Y/%m/%d %H:%M")}&nbsp;</td>
                <td><a href="/access/group_manage?id=${g.group_id}">Edit</a>&nbsp;</td>
			</tr>
			%endfor
			%if my_page.item_count > 0 :
      <tr>
