...
<div id="function-menu">
  ...
  <tbody><tr>
    ...
    <td width="64" valign="top" align="left"><a href="/access/permission_add"><img src="/images/images/menu_new_g.jpg"/></a></td>
...
%if result:
	...
	<table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:800px">
      ...
      %endif
			<tr>
				<th width="300">Permission Name</th>
				<th width="300">Including Role(s)</th>
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="/access/permission_manage?id=${p.permission_id}">Edit</a>&nbsp;</td>
			</tr>
			%endfor
			%if my_page.item_count > 0 :
      <tr>
