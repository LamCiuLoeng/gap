...
<%def name="extTitle()">r-pac - Access - Permission</%def>
    ...
    //<![CDATA[
	    ...
	    function toSave(){
	       if(!$("#permission_name").val()){
	           alert("Please input the permission's name!");
	           return false;       
	       }else{
    	    	$("form").submit();
	       }
...
<div class="s_m_div">
  <div class="select_div">
    <ul>
      <li>
        <label for="inGroup">Roles with permission : </label>
      </li>
      <li>
  ...
  <div class="select_div">
    <ul>
      <li>
        <label for="inGroup">Roles without permission : </label>
      </li>
      <li>
