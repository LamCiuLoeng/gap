...
<div id="function-menu">
  ...
  <tbody><tr>
    ...
    <td width="64" valign="top" align="left"><a href="/access/user_add"><img src="/images/images/menu_new_g.jpg"/></a></td>
...
%if result:
  ...
  <table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:1000px">
    <thead>
      ...
      <tr>
        <td style="text-align:right;border-right:0px;border-bottom:0px" colspan="10">
    ...
    <tbody>
      %for u in result:
      <tr>
        <td><a href="/access/user_edit?id=${u.user_id}">${u.user_name}</a>&nbsp;</td>
