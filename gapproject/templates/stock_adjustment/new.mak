...
<title>r-pac - Stock Adjustment - GAP</title>
...
$(function(){
    ...
    $('#ok-btn').click(function(){
        ...
        if(itemIDs.length > 0){
            ...
            pf.attr('action', '/stockAdjustment/new_form');
            pf.submit(); 
        }
            // p.location.reload(); 
        window.close();
...
<div class="nav-tree">Stock Adjustment&nbsp;&nbsp;&gt;&nbsp;&nbsp;Search Item</div>
<form id="search-form" action="/stockAdjustment/new" method="post">
