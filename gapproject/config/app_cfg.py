# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in GAPProject.
...
from gapproject.config.authMiddleware import MySQLAlchemyAuthenticatorPlugin, FriendlyTimeoutPlugin
from gapproject.lib import app_globals, helpers 

base_config = AppConfig()
base_config.renderers = []

base_config.package = gapproject
...
base_config.model = gapproject.model
base_config.DBSession = gapproject.model.DBSession

# Configure the authentication backend

# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP 
base_config.sa_auth.cookie_secret = "wangjimimale" 
